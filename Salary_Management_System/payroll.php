...
<?php include 'configs/db_config.php'  ?>
    <div class="container">
        ...
        <h3 class="mb-3">Employee Salary</h3>
        ...
        <table class="table">
            ...
            <?php 
                ...
                if ($result->num_rows > 0) {
                    ...
                    <tr>
                        <td>
                            <button type="button" class="btn btn-xl mr-1 <?php echo $color ?> rounded-circle"><?php echo substr($row["first_name"],0,1); ?>
                            </button> <?php echo $row["first_name"].' '.$row["last_name"] ?><br>
                            <small class="ml-2"><span class="badge badge-pill badge-success ml-4"><?php echo $row["department"] ?></span></small>
                        </td>
                        <td class=""><br><?php echo $row["employee_id"] ?></td>
                        <td><br>  <?php echo $row["email"] ?></td>
                        <td><br> <?php echo $row["role"] ?></td>
                        <td><br> ₹ <?php echo $row["salary"] ?></td>
                        <td><br> <button class="btn btn-sm btn-warning" data-toggle="modal" data-target="#myModal<?php echo $row["employee_id"]; ?>">Generate Payslip</button></td>
                    </tr>
                    ...
                    <div class="modal fade" id="myModal<?php echo $row["employee_id"]; ?>">
                        ...
                        <div class="modal-content">
                            ...
                            <h4 class="modal-title text-right">
                                &nbsp;Payslip for Month of <span class="text-danger"><?php echo date("F", mktime(0, 0, 0, $month_num, 10)); ?></span>
                            </h4>
